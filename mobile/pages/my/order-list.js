(() => {
  ...
  const MODULE_ACTION_HANDLER = {
    ...
    EXCHANGE: ({ orderOptionNo, deliverable, payType }) => {
      ...
      location.href = `/pages/my/claim-form.html?orderOptionNo=${orderOptionNo}&claimType=EXCHANGE&deliverable=${deliverable}`;
    },
    RETURN: ({ orderOptionNo, deliverable, payType }) => {
      ...
      location.href = `/pages/my/claim-form.html?orderOptionNo=${orderOptionNo}&claimType=RETURN&deliverable=${deliverable}`;
    },
