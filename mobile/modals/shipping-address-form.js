(() => {
  ...
  const makeRequest = (prevState = {}) => {
    const {
      myShippingAddressAddressInformation: { address, detailAddress, jibunAddress, zipCode } = {},
    ...
    const _prev = _.omit(prevState, Object.keys(myShippingAddressBasicInformation));
